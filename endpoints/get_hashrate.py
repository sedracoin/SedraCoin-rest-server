...
@app.get("/info/hashrate", response_model=HashrateResponse | str, tags=["Sedra network info"])
...
@app.get("/info/hashrate/max", response_model=MaxHashrateResponse, tags=["Sedra network info"])
@sql_db_only
