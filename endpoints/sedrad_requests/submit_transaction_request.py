...
async def submit_a_new_transaction(body: SubmitTransactionRequest):
    """
    Forwards the body directly to sedrad with the command submitTransactionRequest
    """
    tx_resp = await sedrad_client.request("submitTransactionRequest",
                                          params=body.dict())
