...
@app.get("/info/get-vscp-from-block", response_model=VscpResponse, tags=["Sedra network info"])
async def get_virtual_selected_parent_chain_from_block(
    ...
    some startHash to this sedrad's current virtual.
    """
    resp = await sedrad_client.request("getVirtualSelectedParentChainFromBlockRequest",
                                       params={
                                           "startHash": startHash,
