...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_sedrad_info, \
...
from endpoints.sedrad_requests.submit_transaction_request import submit_a_new_transaction
from helper import get_sdr_market_data
...
print(
    ...
    f"{get_sedrad_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
...
async def startup():
    ...
    # get sedrad
    await get_sdr_market_data()

    # find sedrad before staring webserver
