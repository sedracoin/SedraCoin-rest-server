...
from sedrad import messages_pb2 as messages__pb2
...
class P2PStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MessageStream = channel.stream_stream(
                ...
                request_serializer=messages__pb2.SedradMessage.SerializeToString,
                response_deserializer=messages__pb2.SedradMessage.FromString,
                )
...
def add_P2PServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MessageStream': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=messages__pb2.SedradMessage.FromString,
                    response_serializer=messages__pb2.SedradMessage.SerializeToString,
            ),
    }
...
class P2P(object):
    ...
    def MessageStream(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/protowire.P2P/MessageStream',
            messages__pb2.SedradMessage.SerializeToString,
            messages__pb2.SedradMessage.FromString,
